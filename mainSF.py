...
def main(mode):
    ...
    if mode == "train":
        ...
        env = retro.make(game=ENV_NAME, state=state, use_restricted_actions=retro.Actions.DISCRETE, scenario = "custom_scenario")
        num_actions = env.action_space.n
        WEIGHT_PATH = 'C:/Users/jessi/gym-retro/jessica-testing/weights/dqn_cnn_{}_weights.h5f'.format(state)
        ...
        dqn.fit(env, nb_steps=10000, visualize=True, verbose=2, action_repetition=8,
                    callbacks=[checkpointer], nb_max_episode_steps=4000, nb_episodes=1)
